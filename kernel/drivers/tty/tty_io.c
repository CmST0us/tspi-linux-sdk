				   ...
				   const struct attribute_group **attr_grp)
{
	...
	dev->release = tty_device_create_release;
       ...
       if(!strcmp(name, "ttysWK0")){
                sprintf(name, "%s", "ttyS5");
       }else if(!strcmp(name, "ttysWK1")){
               sprintf(name, "%s", "ttyS6");
       }else if(!strcmp(name, "ttysWK2")){
               sprintf(name, "%s", "ttyS7");
       }else if(!strcmp(name, "ttysWK3")){
               sprintf(name, "%s", "ttyS8");
       }
